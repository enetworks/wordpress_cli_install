...
export WP_INSTALL_PLUGINS=("contact-form-7"  "advanced-custom-fields")
export WP_ACTIVATE_PLUGINS=("wp-multibyte-patch")

export WP_THEME_URL='https://www.communitycom.jp/saitama/wp-content/uploads/2016/06/saitama.zip'
